...
export class Convert {
    public static toElementos(json: string): Elementos {
        return cast(JSON.parse(json), r("Elementos"));
    }

    public static elementosToJson(value: Elementos): string {
        return JSON.stringify(uncast(value, r("Elementos")), null, 2);
    }
}
